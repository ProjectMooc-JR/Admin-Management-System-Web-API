...
router.post("/loginOut", authcontroller.logoutAsync);
...
router.post(
  ...
  commonValidate([
    ...
    body("access")
      .notEmpty()
      .withMessage("Not a valid access")
      .isIn(["teacher", "student"]),  // not allow to sign-up as admin
  ]),
